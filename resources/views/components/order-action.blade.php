<div class="flex space-x-1 justify-around" xmlns:x-on="http://www.w3.org/1999/xhtml">
    {{--@can("Update-$model")--}}
    <a href="{{ $url.'/edit' }}" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
    ...
    <a href="{{'/orders/reports/invoice/'.$id}}" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
<button class="mt-1 ">
