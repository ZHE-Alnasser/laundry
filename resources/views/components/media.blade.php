...
{{--<img src="{{$entity->cover}}" alt="{{ $name.__('of').' '.$entity->getTable() }}" class="rounded h-20 w-20 object-cover">--}}
{{--</div>--}}
...
<fieldset class="fileset">
        ...
        <ul>
            ...
            <li>
                <label>
                    ...
                    <input name="{{$name}}" value="{{$m->getFullUrl()}}" data-type="data" checked type="checkbox">
                    {{$m->name}}
                </label>
            </li>
            @endforeach
    ...
    <div class="my-2">
        <input type="file" name="{{$name}}" @isset($multiple) multiple data-max-files="10" data-max-file-size="3MB"
               data-allow-image-preview="false" data-allow-reorder="true"@endisset>
    </div>
...
{{--<script>--}}
{{--var inputElementx = document.querySelector('input[type="file"]');--}}
{{--var pondx = FilePond.create( inputElementx );--}}
{{--</script>--}}
